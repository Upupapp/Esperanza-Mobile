...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _submitForVerification() async {
    ...
    final account = CitizenAccount(
      ...
      address: '${_purok.text.trim()}, Barangay $_barangay, Tereza, Rizal',
      birthdate: '—',
      sex: '—',
      civilStatus: '—',
      occupation: '—',
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: const Text(
            'By creating an Tereza, Rizal account, you agree to provide accurate information for barangay/municipal record-keeping. '
            'Your data is used only for LGU service delivery (document requests, assistance programs, resident records) and is '
            'not shared with third parties. Tereza, Rizal LGU staff may contact you to verify submitted information. False or '
  ...
  Widget _idUploadStep() {
    return Column(
      ...
      children: [
        ...
        const Text(
          'Upload a photo or scan of any valid government-issued ID. This helps Tereza, Rizal LGU verify your identity.',
    ...
    return Column(
      ...
      children: [
        ...
        if (!_alreadyHasAccount)
          const Text(
            'Your information has been submitted to Tereza, Rizal LGU for verification.',
            textAlign: TextAlign.center,
        ...
        AppButton(
          ...
          // "Nicanor/Perlita no longer opening" after using this button
