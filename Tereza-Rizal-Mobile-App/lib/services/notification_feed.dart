  ...
  if (profile != null && profile.overallCompletionPercent < 100) {
    items.add(
      AppNotification(
        ...
        body: 'Finish your Resident Profile so Tereza, Rizal LGU can verify your account and unlock full access. ${profile.overallCompletionPercent}% complete.',
    ...
    return [
      AppNotification(
        ...
        body: resolvedAsSameOwner
            ? 'The original resident confirmed this registration is theirs. Tereza, Rizal allows one account per '
            ...
            : resolvedAsReported
                ...
                : 'An existing Tereza, Rizal account appears to match the information submitted for this account. '
...
List<AppNotification> _unverifiedDuplicateNotifications(
  ...
  if (kept == null) {
    ...
    body = 'Two unverified Tereza, Rizal registrations appear to contain matching resident information. Choose which '
...
AppNotification _duplicateAlertFor(
  ...
  return AppNotification(
    ...
    body: resolution == null
        ? 'Another Tereza, Rizal account was created using information that appears to match your identity. Please '
...
const _sampleNotifications = <_SampleNotification>[
  _SampleNotification(
    ...
    title: 'Typhoon Advisory — Tereza, Rizal',
  ...
  _SampleNotification(
    ...
    body: 'Office of the Municipal Mayor: Fiesta ng Tereza, Rizal opening program this August 14 at the Municipal Plaza.',
    time: '2 days ago',
    age: Duration(days: 2),
  ),
  _SampleNotification(
