...
Run from `Tereza-Rizal-Mobile-App/`:
...
top band, dissolving into Tereza, Rizal navy for the lower third where the headline
...
# Tereza, Rizal navy-950, the palette's darkest ink (lib/theme/app_colors.dart).
NAVY = (0x07, 0x0F, 0x24)
