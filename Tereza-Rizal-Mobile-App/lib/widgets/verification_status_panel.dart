...
class VerificationStatusPanel extends StatelessWidget {
  ...
  String get _explanation => switch (status) {
    AppStatus.pendingReview =>
      'Tereza, Rizal LGU is reviewing your submitted information. This usually takes 1–3 business days — no action needed from you right now.',
    AppStatus.underVerification =>
      'Some of your details need a closer look from Tereza, Rizal LGU staff. No action needed from you right now.',
    AppStatus.approved => 'Your account has been verified. You now have full access to Tereza, Rizal mobile services.',
    AppStatus.rejected =>
