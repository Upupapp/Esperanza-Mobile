...
/// Central ThemeData for the Tereza, Rizal app. Every screen should pull
/// colors/type/radii from here (or the token files it composes) rather than
/// hard-coding values — see TEREZA_RIZAL_MOBILE_WEB_ALIGNMENT.md Section 1.
class AppTheme {
  AppTheme._();
  ...
  static ThemeData get light {
    ...
    return base.copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        // breathing room instead of feeling compressed — some Tereza, Rizal
