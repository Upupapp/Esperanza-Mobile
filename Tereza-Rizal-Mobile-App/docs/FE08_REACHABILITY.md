...
The walk also ignores `package:tereza_rizal/` self-imports, since this codebase uses
...
`assets/images/tereza-rizal-seal.png` present but undeclared while a `Logo/` variant was used.
