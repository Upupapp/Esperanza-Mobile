...
import '../../utils/tereza_rizal_seal.dart';

/// The single Tereza, Rizal municipal payment receipt — used for every payment
...
/// Tereza, Rizal municipal receipt, not a wallet-app-styled one. The only
...
class TerezaRizalReceipt extends StatelessWidget {
  final Receipt receipt;
  const TerezaRizalReceipt({super.key, required this.receipt});
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: ClipOval(
                          child: Image.asset(terezaRizalSealAsset, fit: BoxFit.cover),
                        ),
                      ),
  ...
  /// badge + label so the receipt still reads as an Tereza, Rizal municipal
  /// document first.
...
/// overflow, stretch, or dominate the receipt, which stays an Tereza, Rizal
/// municipal document first. Onsite keeps its original Tereza, Rizal-appropriate
