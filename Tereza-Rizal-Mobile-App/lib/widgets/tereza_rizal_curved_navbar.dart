...
import 'tereza_rizal_center_action.dart';
import 'tereza_rizal_curved_nav_painter.dart';
import 'tereza_rizal_nav_item.dart';
import 'tereza_rizal_nav_motion.dart';
import 'nav_item_data.dart';
import 'service_launcher_menu.dart';

/// Tereza, Rizal's bottom navigation bar — a direct structural/behavioral port
...
/// colors were swapped for Tereza, Rizal's.
///
...
class TerezaRizalCurvedNavBar extends StatelessWidget {
  ...
  // subtle Tereza, Rizal-blue tint rather than a neutral gray, still light
  // enough to stay a hairline, not a new visible container. Applies to
  // the whole painted outline (see TerezaRizalCurvedNavPainter), but the
  ...
  Widget build(BuildContext context) {
    ...
    return RepaintBoundary(
      child: SizedBox(
        height: TerezaRizalNavMotion.barHeight + bottomInset,
        child: LayoutBuilder(
              ...
              children: [
                ...
                Positioned.fill(
                  child: TweenAnimationBuilder<double>(
                    ...
                    duration: TerezaRizalNavMotion.selectionFor(context),
                    curve: TerezaRizalNavMotion.selectionCurve,
                    builder: (context, x, _) {
                      return CustomPaint(
                        key: const ValueKey('nav-bar-shape'),
                        painter: TerezaRizalCurvedNavPainter(
                          cradleCentreX: x,
                ...
                if (activeIndex != null)
                  AnimatedPositioned(
                    ...
                    duration: TerezaRizalNavMotion.selectionFor(context),
                    curve: TerezaRizalNavMotion.selectionCurve,
                    left: activeCentreX - TerezaRizalNavMotion.bubbleDiameter / 2,
                    top: -TerezaRizalNavMotion.bubbleLift,
                    child: IgnorePointer(
                      child: TerezaRizalActiveBubble(item: items[activeIndex!], reduced: reduced),
                    ),
                  ),
                ...
                Positioned(
                  ...
                  left: width / 2 - TerezaRizalNavMotion.centerDiameter / 2,
                  top: -(TerezaRizalNavMotion.centerDiameter / 2),
                  child: TerezaRizalCenterAction(
