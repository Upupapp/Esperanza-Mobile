...
import 'package:tereza_rizal/utils/tereza_rizal_seal.dart';
...
void main() {
  ...
  testWidgets('every asset onboarding references is declared and loadable', (
    ...
    expect(pubspec, contains(terezaRizalSealAsset));

    for (final asset in [
      ...onboardingScenes.map((s) => s.backgroundAsset),
      terezaRizalSealAsset,
    ]) {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      // the Tereza, Rizal this app serves. It is fine as media on a mock
