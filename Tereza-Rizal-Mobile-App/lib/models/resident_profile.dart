...
extension VerificationStatusX on VerificationStatus {
  ...
  String get citizenMessage => switch (this) {
        ...
        VerificationStatus.pendingVerification => 'Tereza, Rizal LGU is reviewing your submission.',
...
class Individual {
  ...
  Individual({
    ...
    this.hasTerezaRizalAccount = false,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'hasTerezaRizalAccount': hasTerezaRizalAccount,
  ...
  factory Individual.fromJson(Map<String, dynamic> json) => Individual(
        ...
        hasTerezaRizalAccount: json['hasTerezaRizalAccount'] ?? false,
