...
**Alpha-composited palette colours (2).** `tereza_rizal_curved_navbar.dart` carried:
...
The second, `Color(0x140F172A)`, was 8 % of Tailwind `slate-900` — a colour the Tereza, Rizal palette
