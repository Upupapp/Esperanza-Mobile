...
import 'package:tereza_rizal/screens/auth/register_screen.dart';
import 'package:tereza_rizal/screens/home/home_screen.dart';
...
import 'package:tereza_rizal/widgets/restricted_feature_notice.dart';
...
void main() {
  ...
  for (final sizeEntry in sizes.entries) {
    for (final textScale in [1.0, 1.3, 2.0]) {
      ...
      testWidgets('TerezaRizalCurvedNavBar (4 tabs) has zero overflow at ${sizeEntry.key}, textScale $textScale', (tester) async {
        SharedPreferences.setMockInitialValues({});
        await pumpAtSize(
          tester,
          sizeEntry.value,
      ...
      testWidgets('TerezaRizalCurvedNavBar (launcher active) has zero overflow at ${sizeEntry.key}, textScale $textScale', (tester) async {
        SharedPreferences.setMockInitialValues({});
        await pumpAtSize(
          tester,
          sizeEntry.value,
