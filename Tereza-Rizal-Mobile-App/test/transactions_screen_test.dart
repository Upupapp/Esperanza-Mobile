...
import 'package:tereza_rizal/screens/shared/transactions_screen.dart';
...
void main() {
  ...
  group('Seeded demo transactions (verified Perlita Quiambao)', () {
    ...
    testWidgets('View Receipt on each seeded transaction opens the unified Tereza, Rizal receipt with correct data', (
      tester,
    ) async {
      final requests = await _loaded(tester);
