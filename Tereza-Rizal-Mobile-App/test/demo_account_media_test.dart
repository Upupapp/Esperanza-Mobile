...
import 'package:tereza_rizal/utils/demo_resident_photo.dart';
import 'package:tereza_rizal/utils/government_id.dart';
...
void main() {
  ...
  group('Digital ID screen', () {
    ...
    // Tereza, Rizal Digital ID and is never shown on this screen — see Profile >
    // Personal Information's own coverage in submitted_government_id_test.dart.
    testWidgets('Nicanor (Unverified): no Tereza, Rizal Digital ID, and no registration ID document either', (tester) async {
      ...
      expect(find.text('Tereza, Rizal Resident ID'), findsNothing);
