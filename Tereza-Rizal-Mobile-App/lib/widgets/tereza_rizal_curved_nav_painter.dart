...
class TerezaRizalCurvedNavPainter extends CustomPainter {
  ...
  const TerezaRizalCurvedNavPainter({
  ...
  Path _buildPath(Size size) {
    const r = TerezaRizalNavMotion.surfaceRadius;
  ...
  @override
  bool shouldRepaint(covariant TerezaRizalCurvedNavPainter oldDelegate) {
