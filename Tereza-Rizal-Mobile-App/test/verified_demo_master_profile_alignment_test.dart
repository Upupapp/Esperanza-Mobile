...
import 'package:tereza_rizal/models/attachment.dart';
import 'package:tereza_rizal/models/resident_profile.dart';
import 'package:tereza_rizal/models/service_request.dart';
import 'package:tereza_rizal/screens/profile/resident_profile/family_information_screen.dart';
import 'package:tereza_rizal/screens/profile/resident_profile/personal_information_screen.dart';
import 'package:tereza_rizal/screens/shared/request_detail_screen.dart';
import 'package:tereza_rizal/screens/shared/request_submitted_screen.dart';
import 'package:tereza_rizal/screens/shared/service_request_wizard_screen.dart';
...
import 'package:tereza_rizal/services/mock_catalog.dart';
...
import 'package:tereza_rizal/theme/app_colors.dart';
import 'package:tereza_rizal/utils/age_calculator.dart';
import 'package:tereza_rizal/widgets/app_button.dart';
    ...
    testWidgets('an old placeholder Perlita profile (Nov 29 1988, no family) is corrected on load, unrelated data preserved', (
      ...
      final staleProfile = ResidentProfile(
        ...
        personal: Individual(
          ...
          barangay: 'Baras',
          sitioPurok: 'Purok 2',
          completeAddress: 'Purok 2, Barangay Baras, Tereza, Rizal',
      ...
      SharedPreferences.setMockInitialValues({
        'tereza_rizal_resident_profiles': jsonEncode({_verifiedDemoId: staleProfile.toJson()}),
      });
      ...
      final resaved = jsonDecode(prefs.getString('tereza_rizal_resident_profiles')!) as Map<String, dynamic>;
