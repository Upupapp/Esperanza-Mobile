...
CitizenAccount _demoAccount() => CitizenAccount(
      ...
      barangay: 'Agoho',
      purok: 'Purok 1',
      address: 'Purok 1, Barangay Agoho, Tereza, Rizal',
      birthdate: '—',
      sex: '—',
      civilStatus: '—',
      occupation: '—',
...
void main() {
  ...
  test('adding/removing family members updates householdResidentCount without duplicating the head', () async {
    ...
    final child = Individual(individualId: 'IND-1', firstName: 'Juan', relationshipToHead: 'Son', hasTerezaRizalAccount: false);
