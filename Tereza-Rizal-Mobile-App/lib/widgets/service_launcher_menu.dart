...
/// like a tab's own raised active bubble (see TerezaRizalActiveBubble: filled
/// circle, white border ring, colored drop shadow) and driven by the same
/// motion constants as the rest of the navbar (TerezaRizalNavMotion), rather
...
/// (the same one TerezaRizalActiveBubble and TerezaRizalCenterAction already
...
class _ServiceLauncherBubblesState extends State<_ServiceLauncherBubbles> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = AnimationController(vsync: this, duration: TerezaRizalNavMotion.selection);
  ...
  void didChangeDependencies() {
    ...
    if (!_started) {
      _started = true;
      _controller.duration = TerezaRizalNavMotion.selectionFor(context);
      _controller.forward();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final clearance =
        bottomSafeInset + TerezaRizalNavMotion.barHeight + TerezaRizalNavMotion.centerDiameter / 2 + 14;
...
class _LauncherBubble extends StatelessWidget {
  ...
  static const double _diameter = TerezaRizalNavMotion.bubbleDiameter;
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(target.icon, color: Colors.white, size: TerezaRizalNavMotion.iconSize),
              ),
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: const TextStyle(
                    ...
                    // Tereza, Rizal primary blue — the same color the navbar's
                    // own active-tab label uses (TerezaRizalNavItem._activeColor)
