...
/// "submission" in Tereza, Rizal — Dokyu, Tulong, registration — is the
...
class _ReportProblemScreenState extends State<ReportProblemScreen> {
  ...
  Future<void> _submit() async {
    ...
    await AppDialogs.info(
      ...
      message:
          'Thank you for the report. Tereza, Rizal does not yet have a live support system connected, so '
          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'This is a demo submission. Tereza, Rizal does not yet have a live support backend, so '
