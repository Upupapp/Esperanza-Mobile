...
import 'package:tereza_rizal/screens/profile/profile_screen.dart';
...
/// Pre-seeds `tereza_rizal_resident_profiles` with a freshly-seeded profile
...
Map<String, Object> _seededPrefs(
  ...
  return <String, Object>{
    'tereza_rizal_resident_profiles': jsonEncode({account.id: profile.toJson()}),
  };
}
