...
import 'package:tereza_rizal/screens/shared/service_catalog_screen.dart';
...
void main() {
  ...
  testWidgets('full fill-through-submit reaches the standard request-submitted screen', (tester) async {
    ...
    await tester.enterText(fetalFields.at(2), 'Tereza, Rizal District Hospital, Poblacion');
    ...
    await tester.enterText(motherFields.at(8), 'Purok 1, Brgy. Agoho, Tereza, Rizal');
    await _continue(tester);
