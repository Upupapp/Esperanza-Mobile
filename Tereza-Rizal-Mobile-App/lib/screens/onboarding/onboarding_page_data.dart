...
const onboardingScenes = <OnboardingSceneSpec>[
  OnboardingSceneSpec(
    ...
    semanticDescription: 'Page 1 of 3: the Tereza, Rizal coastline at sunrise',
...
const onboardingBrandName = 'Municipalidad ng Tereza, Rizal';
...
/// Sur* — a different municipality from the *Tereza, Rizal* this app
/// serves (`settings_screen.dart`: "Municipality of Tereza, Rizal —
/// Region IV-A (CALABARZON)"). It is fine where it sits today, as media on one mock Balita
