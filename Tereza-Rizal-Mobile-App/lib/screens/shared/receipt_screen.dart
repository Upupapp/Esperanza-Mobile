...
import '../../widgets/receipts/tereza_rizal_receipt.dart';
...
/// [TerezaRizalReceipt] design (payment method only changes its "Mode of
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: RepaintBoundary(
            key: _boundaryKey,
            child: TerezaRizalReceipt(receipt: receipt),
          ),
        ),
      ),
