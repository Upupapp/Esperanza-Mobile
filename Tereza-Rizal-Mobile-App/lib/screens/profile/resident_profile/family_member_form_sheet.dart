...
/// without an Tereza, Rizal account must be fully representable here, so
/// "Has Tereza, Rizal Account?" defaults to No and is never required to be
...
class _FamilyMemberFormSheetState extends State<FamilyMemberFormSheet> {
  ...
  void initState() {
    ...
    _hasAccount = e?.hasTerezaRizalAccount ?? false;
  }
  ...
  void _submit() {
    ...
    final result = Individual(
      ...
      hasTerezaRizalAccount: _hasAccount,
    );
