...
import 'package:tereza_rizal/main.dart' as app;
import 'package:tereza_rizal/models/attachment.dart';
import 'package:tereza_rizal/models/master_file_document.dart';
...
void main() {
  ...
  setUpAll(() async {
    ...
    SharedPreferences.setMockInitialValues({
      'tereza_rizal_master_file_documents': jsonEncode({verifiedDemoAccountId: docs}),
    });
  });
  ...
  Future<void> walk(WidgetTester tester) async {
    ...
    // Driven from the drawer's own label list (tereza_rizal_drawer.dart) rather
