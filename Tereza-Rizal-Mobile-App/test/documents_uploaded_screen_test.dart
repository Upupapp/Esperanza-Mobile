...
import 'package:tereza_rizal/screens/shared/documents_uploaded_screen.dart';
...
import 'package:tereza_rizal/widgets/tereza_rizal_drawer.dart';
    ...
    testWidgets('is reachable from the hamburger drawer for a signed-in resident', (tester) async {
      ...
      await tester.pumpWidget(
        MultiProvider(
          ...
          child: const MaterialApp(home: Scaffold(drawer: TerezaRizalDrawer())),
        ),
      );
