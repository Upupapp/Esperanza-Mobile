...
/// screen states must be traceable to what Tereza, Rizal actually does
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: Padding(
            ...
            child: Text(
              'Learn how Tereza, Rizal handles and protects your information.',
              maxLines: 2,
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            'Tereza, Rizal is designed to help residents of the Municipality of Tereza, Rizal interact with '
            ...
            'to us. This Privacy Policy describes what information Tereza, Rizal may collect, why it is used, '
          ...
          ExpandablePanel(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'When you create an account or complete your Resident Profile, Tereza, Rizal may collect '
                  'information such as:',
                  style: AppTypography.body,
                ),
                const SizedBox(height: AppSpacing.sm),
                ...
                const SizedBox(height: AppSpacing.sm),
                const Text('To use Tereza, Rizal, the app maintains:', style: AppTypography.body),
                const SizedBox(height: AppSpacing.sm),
                const BulletList([
                ...
                const SizedBox(height: AppSpacing.sm),
                const Text(
                  'If you choose to complete the Resident Profile feature, Tereza, Rizal may also process:',
                  style: AppTypography.body,
                ),
                const SizedBox(height: AppSpacing.sm),
                const BulletList([
          ...
          ExpandablePanel(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  "Tereza, Rizal only requests access to your camera, photos, or documents when you choose to "
                ...
                const BulletList([
                  ...
                  "Choose a document → Tereza, Rizal uses your device's own document picker wherever possible, rather than requesting broad storage access.",
                ]),
                const SizedBox(height: AppSpacing.sm),
                const Text(
                  'Tereza, Rizal uses the minimum access necessary to complete the action you requested. '
                  'Tereza, Rizal does not access all photos or files on your device.',
                  style: AppTypography.body,
                ),
              ],
            ),
          ...
          ExpandablePanel(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Tereza, Rizal may use notifications for purposes such as:', style: AppTypography.body),
                const SizedBox(height: AppSpacing.sm),
                const BulletList([
          ...
          ExpandablePanel(
            ...
            child: const Text(
              'Information you submit through Tereza, Rizal may need to be accessible to authorized municipal '
              "personnel or offices responsible for processing the relevant service (for example, the office "
              'handling your Dokyu or Tulong request). Tereza, Rizal does not share your information with any '
              ...
              'must be confirmed by the Municipality of Tereza, Rizal before production release.',
              style: AppTypography.body,
            ),
          ),
          ...
          ExpandablePanel(
            ...
            child: const Text(
              'Tereza, Rizal aims to use reasonable technical and organizational safeguards to help protect '
              ...
              'systems used in production must be confirmed by the Municipality of Tereza, Rizal before this policy '
              'is finalized.',
              style: AppTypography.body,
            ),
          ),
          ...
          ExpandablePanel(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Tereza, Rizal does not define its own retention periods. Information should only be '
                  'retained according to applicable municipal requirements, legal obligations, and approved '
                  'retention policies of the Municipality of Tereza, Rizal.',
                  style: AppTypography.body,
                ),
                const SizedBox(height: AppSpacing.sm),
                const Text(
          ...
          ExpandablePanel(
            ...
            child: const Text(
              ...
              'required for municipal services, and should be handled with appropriate safeguards. Tereza, Rizal '
          ...
          ExpandablePanel(
            ...
            child: const Text(
              "Tereza, Rizal currently uses a small number of device-level packages to support its features "
              ...
              'to Tereza, Rizal. This app does not currently connect to any external backend or third-party server.\n\n'
              'This section must be reviewed and confirmed by the Municipality of Tereza, Rizal before production '
