  ...
  group('Real-app construction (seedDemoData: false, retireLegacyDemoRequestSeeds: true)', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        SharedPreferences.setMockInitialValues({
          'tereza_rizal_service_requests': jsonEncode([...legacySeeds, genuine].map((r) => r.toJson()).toList()),
        });
    ...
    testWidgets('the cleanup is persisted — reloading from the same storage does not resurrect the seeds', (
      ...
      SharedPreferences.setMockInitialValues({
        'tereza_rizal_service_requests': jsonEncode(legacySeeds.map((r) => r.toJson()).toList()),
      });
