...
Future<void> _pumpSignedInAsVerifiedDemo(WidgetTester tester, Size size) async {
  ...
  // as they build (see dokyu_screen.dart's own doc comment) -- the FAB
  // being under test never renders at all without a fake backend to answer
  // that, since AsyncStateView shows its error state instead of content.
