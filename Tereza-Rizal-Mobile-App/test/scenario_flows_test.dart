...
// (TerezaRizalApp) with real taps — not just code review.
import 'package:flutter/material.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:shared_preferences/shared_preferences.dart';

import 'package:tereza_rizal/main.dart';
import 'package:tereza_rizal/widgets/demo_account_card.dart';
...
void main() {
  testWidgets('Scenario A — Guest: Home -> Balita public -> Dokyu shows restricted notice', (tester) async {
    ...
    expect(
      find.text('This feature is available to registered Tereza, Rizal users. Create an account or sign in to continue.'),
      findsOneWidget,
    );
  });
  ...
  testWidgets('Scenario C — Perlita Quiambao: fully verified, full access, no guest/verification warnings', (tester) async {
    ...
    expect(find.text('This feature is available to registered Tereza, Rizal users. Create an account or sign in to continue.'), findsNothing);
