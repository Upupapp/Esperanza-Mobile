...
import '../../widgets/tereza_rizal_drawer.dart';
...
class BalitaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: const TerezaRizalDrawer(),
      appBar: AppBar(title: const Text('Balita'), actions: const [AlertsAction()]),
      body: posts.isEmpty
          ? const EmptyState(
              icon: Icons.campaign_outlined,
              title: 'No announcements available',
              description: 'Check back soon for updates from Tereza, Rizal LGU.',
            )
          ...
          : ListView.builder(
              ...
              // widgets/tereza_rizal_curved_navbar.dart) — without it, the last
