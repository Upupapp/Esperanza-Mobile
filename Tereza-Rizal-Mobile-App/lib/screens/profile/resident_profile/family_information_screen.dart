          ...
          children: [
            ...
            if (profile.familyMembers.isEmpty)
              Container(
                ...
                child: const Text(
                  'No family members added yet. Add anyone living with you — even if they don\'t have an Tereza, Rizal account.',
...
class _MemberTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final subtitleParts = <String>[
      ...
      member.hasTerezaRizalAccount ? 'Has Tereza, Rizal account' : 'No Tereza, Rizal account',
    ];
    return Padding(
