...
///
/// Falls back to the Tereza, Rizal municipal seal when an office has no clear
...
/// Returns the logo asset for [office], or [terezaRizalSealAsset] if none is
...
/// one agency at once.
String officeLogoAsset(String office) => _officeLogos[office] ?? terezaRizalSealAsset;
