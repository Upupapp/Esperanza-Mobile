      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: Padding(
            ...
            child: Text(
              'Find answers, learn how to use Tereza, Rizal, or get help with a problem.',
              maxLines: 2,
      ...
      body: ListView(
        ...
        children: [
          ...
          const ExpandablePanel(
            ...
            child: Text(
              'Completing your Resident Profile helps Tereza, Rizal LGU verify your account and unlocks full access '
              'to Tereza, Rizal’s services.',
              style: AppTypography.body,
            ),
          ),
          const ExpandablePanel(
          ...
          const ExpandablePanel(
            title: 'What is Dokyu?',
            child: Text(
              'Dokyu is the section of Tereza, Rizal used to request and track supported municipal documents, '
          ...
          const ExpandablePanel(
            ...
            child: Text(
              ...
              'Tereza, Rizal does not currently include a formal appeal process within the app.',
              style: AppTypography.body,
            ),
          ),
          const SizedBox(height: AppSpacing.lg),
          ...
          const ExpandablePanel(
            ...
            child: Text(
              'Tulong is the section of Tereza, Rizal used to request supported municipal assistance programs.',
              style: AppTypography.body,
            ),
          ),
          const ExpandablePanel(
          ...
          const ExpandablePanel(
            title: 'Why does Tereza, Rizal ask for camera permission?',
            child: Text(
          ...
          const ExpandablePanel(
            title: 'Why does Tereza, Rizal ask for photo access?',
            child: Text(
          ...
          const ExpandablePanel(
            ...
            child: Text(
              'You can try the action again — Tereza, Rizal will ask again if needed. If the permission was '
              'permanently disabled, you may need to enable it from your device’s Settings; Tereza, Rizal will '
          ...
          const ExpandablePanel(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Tereza, Rizal may show notifications for:', style: AppTypography.body),
                SizedBox(height: AppSpacing.sm),
                BulletList([
                  'Dokyu updates',
                  'Tulong updates',
          ...
          const ExpandablePanel(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: AppSpacing.sm),
                BulletList([
                  'Check notification permission for Tereza, Rizal',
                  'Check your device’s notification settings',
                  'Check your internet connection',
                  'Restart or reopen the app',
                  'Check whether notifications are disabled for Tereza, Rizal',
                ]),
              ],
            ),
          ),
          ...
          const ExpandablePanel(
            ...
            child: Text(
              'Balita provides municipal and community news and updates published by Tereza, Rizal LGU.',
              style: AppTypography.body,
            ),
          ),
          const ExpandablePanel(
            ...
            child: Text(
              'Events shows upcoming events, activities, and celebrations in Tereza, Rizal.',
              style: AppTypography.body,
            ),
          ),
          const ExpandablePanel(
          ...
          const ExpandablePanel(
            ...
            child: Text(
              ...
              'and hotlines, while Balita is Tereza, Rizal’s general community news and updates feed. In a '
              'life-threatening emergency, call 911 or MDRRMO directly — Tereza, Rizal is not a substitute '
          ...
          const ExpandablePanel(
            ...
            child: Text(
              ...
              'enable Camera permission for Tereza, Rizal from your device Settings, then try again.',
              style: AppTypography.body,
            ),
          ),
          const ExpandablePanel(
          ...
          const ExpandablePanel(
            ...
            child: Text(
              'Check that notification permission is enabled for Tereza, Rizal in your device Settings, and that '
          ...
          AppCard(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('Municipality of Tereza, Rizal Support', style: AppTypography.subsectionLabel),
          ...
          const Center(
            child: Text(
              'Tereza, Rizal — Version 1.0.0 (Frontend Preview Build)',
