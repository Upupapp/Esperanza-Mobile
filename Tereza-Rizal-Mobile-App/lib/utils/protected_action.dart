...
const _copy = <ProtectedResource, _ResourceCopy>{
  ProtectedResource.camera: _ResourceCopy(
    ...
    explanation: 'Tereza, Rizal needs access to your camera so you can take a photo and attach it to your request.',
  ...
  ProtectedResource.photos: _ResourceCopy(
    ...
    explanation: 'Tereza, Rizal needs access to your photos so you can select an image to attach to your request.',
  ...
  ProtectedResource.document: _ResourceCopy(
    ...
    explanation: 'Tereza, Rizal needs permission to let you choose a document to attach to your request.',
...
/// Shows the Tereza, Rizal-styled explanation dialog (Not Now / Continue) for
