...
/// barangay-specific document — see TEREZA_RIZAL_MOBILE_WEB_ALIGNMENT.md
...
class MockCatalog {
  ...
  /// RESIDENCY.docx — both official Tereza, Rizal barangay forms use the same
  /// purpose checklist.
  ...
  static const documentTypes = <CatalogItem>[
    ...
    CatalogItem(
      ...
      demoDefaults: {
        ...
        'party1Residence': 'Purok 2, Barangay Baras, Tereza, Rizal',
    ...
    CatalogItem(
      ...
      demoDefaults: {
        ...
        'spayedNeutered': 'No',
        'ownerAddress': 'Purok 2, Barangay Baras, Tereza, Rizal',
    ...
    CatalogItem(
      ...
      // Clearance.pdf — no official Tereza, Rizal Locational Clearance form
      ...
      demoDefaults: {
        ...
        'projectLocation': 'Purok 2, Barangay Baras, Tereza, Rizal',
        'floorArea': '45',
        'lotArea': '120',
  ...
  /// Real Tereza, Rizal event posters, each its own independent entry (never
  ...
  static final events = [
    ...
    EventItem(
      ...
      venue: 'Tereza, Rizal Covered Court',
  ...
  static final announcements = [
    // Admin-published recognition photo. The photograph was not edited.
    // Post copy names LGU Tereza, Rizal. The certificate and trophy still
    // show the award title "4th Gawad Iba Ka Juan: Best Mangrove Award in
    // the Bicol Region," dated July 27, 2026, for Domorog & Sorosimbahan
    // Mangroves (2nd Runner-Up on the certificate, "2nd Place" on the plaque).
    Announcement(
      id: 'bal-mangrove-award',
      official: 'Tereza, Rizal LGU',
      author: 'Tereza, Rizal LGU',
      barangay: null,
      body:
          'Domorog & Sorosimbahan Mangroves Receive Recognition\n\n'
          'LGU Tereza, Rizal was recognized as 2nd Runner-Up in the 4th Gawad Iba Ka Juan: Best Mangrove Award in the Bicol Region, '
    ...
    Announcement(
      ...
      media: const PostMedia(path: 'assets/images/tereza-rizal-aerial.jpg', type: PostMediaType.image, isAsset: true),
      likes: 214,
      shares: 18,
      viewCount: 320,
      comments: [
        PostComment(author: 'Nicanor Sarmiento', body: 'Sama-sama tayo dito, Tereza, Rizal! 🎉', time: '20 hrs ago'),
    ...
    Announcement(
      ...
      viewCount: 165,
      comments: [
        PostComment(author: 'Tereza, Rizal LGU', body: 'Salamat sa inyong serbisyo, Brgy. Santiago! 👏', time: '2 hrs ago'),
      ],
    ),
    Announcement(
      id: 'bal-3',
  ...
  static final demoAccounts = [
    CitizenAccount(
      ...
      barangay: 'Labangtaytay',
      purok: 'Purok 2',
      address: 'Purok 2, Barangay Labangtaytay, Tereza, Rizal',
    ...
    CitizenAccount(
      ...
      barangay: 'Baras',
      purok: 'Purok 2',
      address: 'Purok 2, Barangay Baras, Tereza, Rizal',
  ...
  static const verifiedDemoDigitalCredentials = <DigitalCredential>[
    DigitalCredential(
      ...
      issuer: 'Municipality of Tereza, Rizal',
    ),
    DigitalCredential(
      id: 'perlita-pwd-id',
      type: 'pwd_id',
  ...
  /// assets/images/NICANOR ID DEMO.png, a purpose-built "Tereza, Rizal Resident
  ...
  static const pendingDemoGovernmentId = GovernmentIdRecord(
    ...
    idType: 'Tereza, Rizal Resident ID',
  ...
  static final unverifiedDuplicateAccountA = CitizenAccount(
    ...
    barangay: 'Libertad',
    purok: 'Purok 3',
    address: 'Purok 3, Barangay Libertad, Tereza, Rizal',
